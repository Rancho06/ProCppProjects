...
void CZombieView::DrawGrid()
{
	...
	m_GraphicsImage.DrawString(CA2W(messages[1].c_str()), -1, &font, PointF(620, 285), &brush);
	m_GraphicsImage.DrawString(CA2W(messages[2].c_str()), -1, &font, PointF(620, 300), &brush);
	m_GraphicsImage.DrawString(CA2W(messages[3].c_str()), -1, &font, PointF(620, 315), &brush);
